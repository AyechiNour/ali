...
<body>
    <header>
        <div class="container-fluid pt-3" style="z-index: 9999;">
            <div class="row">
    ...
    <main>
        <!-- <svg id="line1">
            <path id="drow_line" data-name="Path 1650"
                d="M-3.471-1009.426s-25.226-6.169-39.839,264.4-25.226,539.3-18.615,817.867c11.38,479.47,3.041,628.633,103.974,835.614,128.25,263,409.526,168.927,427.7,158.987,50.111-26.118,175.75-76.628-250.8-13.436s-508.614,309.12-508.614,309.12"
                transform="translate(290.613 1010.46)" fill="none" stroke="#fff" stroke-width="2" />
            <path id="drow_line2" data-name="Path 1667"
                d="M-3293.126,781.159s-34.488,241.224,362.294,158.46-277.322,194.01-296.978,297.708,231.983-.7,218.352,117.087S-3295.21,1669.606-3281.632,1779"
                transform="translate(3295.032 -781.018)" fill="none" stroke="#000" stroke-width="2" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="490.04" height="998.11" viewBox="0 0 490.04 998.11">
            ...
            <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./static/img/bg.png" class="d-block w-100" alt="Bryhel Logistics" />
                        <div class="carousel-caption d-none d-md-block">
                            <div class="container">
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="w-50">
                                        <img src="./static/img/truck.png" alt="truck" style="max-width: 489px"
                                            data-aos="fade-right" data-aos-duration="2000">
                                        <h1 class="mb-3 ms-5 text-white" data-aos="fade-down" data-aos-duration="3000">
                                            Logistics</h1>
                                        <p class="ms-5 mb-5" data-aos="fade-up" data-aos-duration="3000">
                                            We provide over 100 existing formulas for private label manufacturing and
                                            can also adapt our
                                            formulas to your specifications (texture, fragrance, color, clean products,
                                            paraben-free
                    ...
                    <div class="carousel-item">
                        <img src="./static/img/bg.png" class="d-block w-100"
                            alt="Bryhel Logistics" />
                        <div class="carousel-caption d-none d-md-block">
                            <div class="container">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="w-70" style="padding-top: 20%;">

                                        <h1 class="mb-3 h-51 ms-5 text-white" data-aos="fade-down" data-aos-duration="3000">
                                            Website design &<br>
                                            Marketing strategy
                                        </h1>
                                        <p class="ms-5 mb-5" style="font-size: 21px;" data-aos="fade-up" data-aos-duration="3000">
                                            Nous fournissons plus de 100 formules existantes<br> pour la fabrication de
                                            marques de distributeur et<br> pouvons également adapter nos formules à vos<br>
                                            spécifications (texture, parfum, couleur, produits<br> propres, produits sans
                                            parabènes, produits sans<br> sodium, produits sans alcool, etc.)
                                        </p>
                                    </div>
                ...
                <div class="row" style="padding-top: 20%;">
                    ...
                    <div class="col-md-5 order-md-1">
                        <form action="">
                            ...
                            <div class="form-outlin mb-4" style="z-index: 9999;"><button type="button"
    ...
    <script>
        ...
        var line2 = document.getElementById("drow_line2");
